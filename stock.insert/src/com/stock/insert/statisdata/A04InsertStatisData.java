 ...
 *
 */
public class A04InsertStatisData {
	static Connection conn = JdbcUtils.getMysqlCon("stock_data");
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		A04InsertStatisData insertStatisData = new A04InsertStatisData();
		try {
			insertStatisData.insertStatisData("stock_2017");
	...
	public void insertStatisData(String stockData) throws SQLException{
...
//		StringBuffer dataSQL = new StringBuffer();
	...
	public HashMap<String, String> getStatisData(String startDate,String endDate,int flag) throws SQLException{
		...
		while(sData.next()){
			...
			if(flag == 2){
				statisData.put(sData.getString("securityCode"), "'"+sData.getString("ZhangFu")+"','"+sData.getString("zhenfu")+"'");
			}
			if(flag == 3){
